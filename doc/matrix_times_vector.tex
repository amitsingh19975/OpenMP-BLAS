...
Total Number of Operations $=$ ($n$ or $m$) $\times$ (Number of Multiplication $+$ Number of Addition)

Total Number of Operations $= n \times (m - 1 + m)$ or $m \times (n - 1 + n)$

Total Number of Operations $= n \times (2m - 1)$ or $m \times (2n - 1)$
